...
import { Target, AlertTriangle, Lightbulb, CheckCircle, ArrowLeft, Printer } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    try {
      ...
      setData({
        ...
        skills: parsedFeedback.skills_found || parsedFeedback.matched_skills || [],
      });
    } catch (e) {
  ...
  return (
    <div className="min-h-screen p-8 relative overflow-hidden bg-background">
      ...
      <div className="max-w-7xl mx-auto space-y-8 relative z-10">
        <header className="pb-6 border-b border-white/10 relative flex flex-col sm:flex-row justify-between sm:items-end gap-4">
          <div className="flex items-start gap-4">
            <button 
              onClick={() => navigate('/dashboard')}
              className="p-2 text-textMuted hover:text-white transition-colors print:hidden"
